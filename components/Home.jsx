      ...
      <div className="h-600px md:h-screen">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl text-black font-bold leading-tight mx-4">
            ...
            <p className="md:text-3xl mx-4 text-grey font-semibold text-left">
            En ContenedoresMG, sabemos lo importante que es mantener tus productos a la temperatura adecuada. 
